          ...
          {tasks.length === 0 ? (
            ...
            tasks.map((task) => (
              <motion.div
                ...
                className={cn(
                  "group flex items-center gap-6 p-5 rounded-[1.5rem] transition-all duration-500 border relative overflow-hidden",
                  task.completed 
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3">
                    ...
                    <p className={cn(
                      "text-base text-[#1D3441] transition-all duration-500 truncate tracking-tight font-medium",
